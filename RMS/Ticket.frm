...
Label12.Caption = pnrgrab
ado.Open "Select * From Reservation Where PNR='" & pnrgrab & "'", con, adOpenStatic, adLockReadOnly
Label10.Caption = ado.Fields(5)
Label13.Caption = ado.Fields(6)
Label11.Caption = ado.Fields(1)
Label14.Caption = ado.Fields(9)
Label15.Caption = ado.Fields(7)
Label25.Caption = ado.Fields(8)
Label9.Caption = ado.Fields(11)
ado.Close

rs.Open "Select PNR, Passenger_name, Age, Sex, Coach, Seat From Reservation Where ByAccount='" & grab & "'", con, adOpenStatic, adLockReadOnly
